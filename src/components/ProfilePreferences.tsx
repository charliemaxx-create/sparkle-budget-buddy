...
import { CategoryManagement } from './categories/CategoryManagement'; // Import CategoryManagement
...
export const ProfilePreferences = () => {
  ...
  return (
    <div className="space-y-6"> {/* Added a div to wrap multiple cards */}
      ...
      <CategoryManagement /> {/* New Category Management component */}
    </div>
  );
};